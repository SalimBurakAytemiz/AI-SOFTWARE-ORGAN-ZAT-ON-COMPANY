 ...
 * yapılandırılmadıkça bu sınıfı ASLA seçmez, bu yüzden faz 3'te çalıştırılmaz.
 *
 ...
 * ----------------------------------------------------------------------------
 * 1. Tipler:  `npx supabase gen types typescript --linked > src/lib/db/database.types.ts`
 *    -> gevşek iskelet gerçek tablo tipleriyle değişir.
 *
